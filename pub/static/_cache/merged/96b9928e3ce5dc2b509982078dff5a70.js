...
var config = {
    map: {
        '*': {
            'countdown-timer': 'MageWorx_CountdownTimersBase/js/countdown-timer',
            'countdown-timer-widget': 'MageWorx_CountdownTimersBase/js/countdown-timer-widget'
        }
    }
};
...
var config = {
    map: {
        '*': {
            'reminder-popup': 'MageWorx_ReviewReminderBase/js/reminder-popup',
        }
    }
};
...
var config = {
    map: {
        '*': {
            'reward-promise': 'MageWorx_RewardPoints/js/reward-promise'
        }
    }
};
...
var config = {
    map: {
        '*': {
            'campaign-popup': 'MageWorx_SocialProofBase/js/campaign-popup',
            'campaign-html-text': 'MageWorx_SocialProofBase/js/campaign-html-text'
        }
    }
};
...
var config = {
    map: {
        '*': {
            stockUpdate: 'MageWorx_StockStatus/js/stockUpdate'
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*': {
            ...
            Wkwalletcustom: 'Webkul_Walletsystem/js/Wkwalletcustom'
        }
    }
};
require.config(config);
