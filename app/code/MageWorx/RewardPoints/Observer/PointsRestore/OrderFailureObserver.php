...
class OrderFailureObserver implements ObserverInterface
{
    /**
     ...
     * @var string
     */
    protected $eventCode = \MageWorx\RewardPoints\Model\EventStrategyFactory::ORDER_FAILURE_RESTORE_EVENT;
