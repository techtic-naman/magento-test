...
namespace MageWorx\SocialProofBase\Controller\Adminhtml\Campaign\Restriction;
...
class NewConditionHtml extends \MageWorx\SocialProofBase\Controller\Adminhtml\Campaign
{
    ...
    public function execute(): void
    {
        ...
        $conditionModel = $this->_objectManager->create($type)
                                               ->setId($id)
                                               ->setType($type)
                                               ->setRule($this->rulesHelper->getRestrictionRuleModel())
                                               ->setPrefix(RestrictionRule::CONDITIONS_PREFIX);
