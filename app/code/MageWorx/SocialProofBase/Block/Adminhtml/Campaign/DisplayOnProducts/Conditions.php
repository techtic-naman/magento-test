...
namespace MageWorx\SocialProofBase\Block\Adminhtml\Campaign\DisplayOnProducts;
...
class Conditions extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    {
        $conditionsName       = 'display_on_products_conditions';
        ...
        if ($this->getCampaign()) {
            ...
            $ruleModel            = $this->rulesHelper->getDisplayOnProductsRuleModel($this->getCampaign());
        } else {
            $ruleModel = $this->rulesHelper->getDisplayOnProductsRuleModel();
        }

        $newChildUrl = $this->getUrl(
            'mageworx_socialproofbase/campaign_displayOnProducts/newConditionHtml/form/' . $conditionsFieldSetId,
