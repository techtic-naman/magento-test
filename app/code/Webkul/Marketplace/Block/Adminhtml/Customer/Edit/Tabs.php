...
class Tabs extends Generic implements TabInterface
{
    ...
    public function initForm()
    {
        ...
        if ($partner['tiktok_active'] == 1) {
            $tiktokActive = "value='1' checked='checked'";
        }
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'all_store',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Update Information in other stores'),
                'title' => __('Update Information in other stores'),
                'values' => $this->mpHelper->getSeparatePanelOptions(),
                'value' => 0,
            ]
        );
        $fieldset->addField(
            ...
            [
                ...
                'after_element_html' => '<input
                    ...
                    '.$twAactive.'
                ><span>'.__('Allow to Display Twitter Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'facebook_id',
            ...
            [
                ...
                'after_element_html' => '<input
                    ...
                    '.$fbAactive.'
                ><span>'.__('Allow to Display Facebook Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'instagram_id',
            ...
            [
                ...
                'after_element_html' => '<input
                    ...
                    '.$instagramActive.'
                ><span>'.__('Allow to Display Instagram Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'youtube_id',
            ...
            [
                ...
                'after_element_html' => '<input
                    ...
                    '.$youtubeActive.'
                ><span>'.__('Allow to Display Youtube Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'vimeo_id',
            ...
            [
                ...
                '.$vimeoActive.'
            ><span>'.__('Allow to Display Vimeo Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'pinterest_id',
            ...
            [
                ...
                'after_element_html' => '<input
                    ...
                    '.$pinterestActive.'
                ><span>'.__('Allow to Display Pinterest Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'moleskine_id',
            ...
            [
                ...
                'after_element_html' => '<input
                    ...
                    '.$moleskineActive.'
                ><span>'.__('Allow to Display Moleskine Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'tiktok_id',
            ...
            [
                ...
                'label' => __('Tiktok ID'),
                'title' => __('Tiktok ID'),
                'value' => $partner['tiktok_id'],
                'after_element_html' => '<input
                    type="checkbox"
                    name="tiktok_active"
                    data-form-part="customer_form"
                    title="'.__('Allow to Display Tiktok Icon in Profile Page').'"
                    '.$tiktokActive.'
                ><span>'.__('Allow to Display Tiktok Icon in Profile Page')."</span>",
            ]
        );
        $fieldset->addField(
            'contact_number',
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'name' => 'is_separate_panel',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Allow seller separate dashboard'),
                'title' => __('Allow seller separate dashboard'),
                'values' => $this->mpHelper->getSeparatePanelOptions(),
                'value' => $partner['is_separate_panel'],
            ]
        );
        $fieldset->addField(
            'shop_title',
