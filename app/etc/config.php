...
return [
    'modules' => [
        ...
        'MageWorx_CountdownTimersBase' => 1,
        'MageWorx_GeoIP' => 1,
        'MageWorx_Info' => 1,
        'MageWorx_OpenAI' => 1,
        'MageWorx_PersonalPromotion' => 1,
        'MageWorx_XReviewBase' => 1,
        'MageWorx_ReviewReminderBase' => 1,
        'MageWorx_RewardPoints' => 1,
        'MageWorx_RewardPointsImportExport' => 1,
        'MageWorx_SocialProofBase' => 1,
        'MageWorx_StockStatus' => 1,
        'MageWorx_ReviewAIBase' => 1,
        'Mageants_ExtensionVersionInformation' => 1,
        'Mageants_VoiceSearch' => 1,
