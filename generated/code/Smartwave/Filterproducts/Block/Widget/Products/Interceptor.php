...
class Interceptor extends \Smartwave\Filterproducts\Block\Widget\Products implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDayDate');
        return $pluginInfo ? $this->___callPlugins('getDayDate', func_get_args(), $pluginInfo) : parent::getDayDate();
    }
