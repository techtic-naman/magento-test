...
class Interceptor extends \Magento\InventoryShippingAdminUi\Block\Adminhtml\Order\View\ShipButton implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSourceSelectionUrl');
        return $pluginInfo ? $this->___callPlugins('getSourceSelectionUrl', func_get_args(), $pluginInfo) : parent::getSourceSelectionUrl();
    }
