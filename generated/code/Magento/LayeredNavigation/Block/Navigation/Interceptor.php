...
class Interceptor extends \Magento\LayeredNavigation\Block\Navigation implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStateHtml');
        return $pluginInfo ? $this->___callPlugins('getStateHtml', func_get_args(), $pluginInfo) : parent::getStateHtml();
    }
    ...
    public function getFilters()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getFilters', func_get_args(), $pluginInfo) : parent::getFilters();
    }
    ...
    public function getClearUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getClearUrl', func_get_args(), $pluginInfo) : parent::getClearUrl();
    }
