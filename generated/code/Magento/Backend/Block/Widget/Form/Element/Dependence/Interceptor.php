...
class Interceptor extends \Magento\Backend\Block\Widget\Form\Element\Dependence implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFieldMap');
        return $pluginInfo ? $this->___callPlugins('addFieldMap', func_get_args(), $pluginInfo) : parent::addFieldMap($fieldId, $fieldName);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addConfigOptions');
        return $pluginInfo ? $this->___callPlugins('addConfigOptions', func_get_args(), $pluginInfo) : parent::addConfigOptions($options);
    }
