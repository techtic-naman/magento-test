...
class Interceptor extends \Magento\Config\Block\System\Config\Tabs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSectionUrl(\Magento\Config\Model\Config\Structure\Element\Section $section)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSectionUrl', func_get_args(), $pluginInfo) : parent::getSectionUrl($section);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSectionActive');
        return $pluginInfo ? $this->___callPlugins('isSectionActive', func_get_args(), $pluginInfo) : parent::isSectionActive($section);
    }
