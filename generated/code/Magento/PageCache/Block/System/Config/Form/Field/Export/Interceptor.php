...
class Interceptor extends \Magento\PageCache\Block\System\Config\Form\Field\Export implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVarnishVersion');
        return $pluginInfo ? $this->___callPlugins('getVarnishVersion', func_get_args(), $pluginInfo) : parent::getVarnishVersion();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTtlValue');
        return $pluginInfo ? $this->___callPlugins('getTtlValue', func_get_args(), $pluginInfo) : parent::getTtlValue();
    }
