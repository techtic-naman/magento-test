...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Event\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRecentlyFiler');
        return $pluginInfo ? $this->___callPlugins('addRecentlyFiler', func_get_args(), $pluginInfo) : parent::addRecentlyFiler($typeId, $subjectId, $subtype, $ignore, $limit);
    }
