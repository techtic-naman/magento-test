...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
     ...
     * @return float|null
     */
    public function getBaseMwRwrdpointsCurAmnt()
    {
        return $this->_get('base_mw_rwrdpoints_cur_amnt');
    }

    /**
     * @param float $baseMwRwrdpointsCurAmnt
     * @return $this
     */
    public function setBaseMwRwrdpointsCurAmnt($baseMwRwrdpointsCurAmnt)
    {
        $this->setData('base_mw_rwrdpoints_cur_amnt', $baseMwRwrdpointsCurAmnt);
        return $this;
    }
