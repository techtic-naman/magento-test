...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Invoice\Create\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function hasInvoiceShipmentTypeMismatch()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('hasInvoiceShipmentTypeMismatch', func_get_args(), $pluginInfo) : parent::hasInvoiceShipmentTypeMismatch();
    }
    ...
    public function canShipPartiallyItem()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('canShipPartiallyItem', func_get_args(), $pluginInfo) : parent::canShipPartiallyItem();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getForcedShipmentCreate');
        return $pluginInfo ? $this->___callPlugins('getForcedShipmentCreate', func_get_args(), $pluginInfo) : parent::getForcedShipmentCreate();
    }
