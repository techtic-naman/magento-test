...
class Interceptor extends \Mageplaza\LayeredNavigation\Block\Navigation\FilterRenderer\CategoryTree implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCategoryTreeHtml($filter)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCategoryTreeHtml', func_get_args(), $pluginInfo) : parent::getCategoryTreeHtml($filter);
    }
    ...
    public function setFilter($filter)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setFilter', func_get_args(), $pluginInfo) : parent::setFilter($filter);
    }
    ...
    public function isAutoExpand()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('isAutoExpand', func_get_args(), $pluginInfo) : parent::isAutoExpand();
    }
