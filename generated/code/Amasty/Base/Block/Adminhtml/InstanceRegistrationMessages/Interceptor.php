<?php
namespace Amasty\Base\Block\Adminhtml\InstanceRegistrationMessages;

/**
 * Interceptor class for @see \Amasty\Base\Block\Adminhtml\InstanceRegistrationMessages
 */
class Interceptor extends \Amasty\Base\Block\Adminhtml\InstanceRegistrationMessages implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Amasty\Base\Model\SysInfo\Command\LicenceService\GetCurrentLicenseValidation $getCurrentLicenseValidation, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $getCurrentLicenseValidation, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAmastyProductsSection');
        return $pluginInfo ? $this->___callPlugins('isAmastyProductsSection', func_get_args(), $pluginInfo) : parent::isAmastyProductsSection();
    }

    /**
     * {@inheritdoc}
     */
    public function getLicenseValidation() : \Amasty\Base\Model\SysInfo\Data\LicenseValidation
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLicenseValidation');
        return $pluginInfo ? $this->___callPlugins('getLicenseValidation', func_get_args(), $pluginInfo) : parent::getLicenseValidation();
    }
