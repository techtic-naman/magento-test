...
class Interceptor extends \Amasty\Base\Block\Adminhtml\System\Config\Form\Field\LicenseKeys implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExistingKeysData');
        return $pluginInfo ? $this->___callPlugins('getExistingKeysData', func_get_args(), $pluginInfo) : parent::getExistingKeysData();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getElementName');
        return $pluginInfo ? $this->___callPlugins('getElementName', func_get_args(), $pluginInfo) : parent::getElementName();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getColumnNames');
        return $pluginInfo ? $this->___callPlugins('getColumnNames', func_get_args(), $pluginInfo) : parent::getColumnNames();
    }
