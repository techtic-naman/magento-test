...
class Interceptor extends \Amasty\Base\Block\Adminhtml\Notification implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUpdatesCount');
        return $pluginInfo ? $this->___callPlugins('getUpdatesCount', func_get_args(), $pluginInfo) : parent::getUpdatesCount();
    }
