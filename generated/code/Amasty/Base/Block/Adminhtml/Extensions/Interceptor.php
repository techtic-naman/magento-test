...
class Interceptor extends \Amasty\Base\Block\Adminhtml\Extensions implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getModulesDataJson');
        return $pluginInfo ? $this->___callPlugins('getModulesDataJson', func_get_args(), $pluginInfo) : parent::getModulesDataJson();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isOriginMarketplace');
        return $pluginInfo ? $this->___callPlugins('isOriginMarketplace', func_get_args(), $pluginInfo) : parent::isOriginMarketplace();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSeoparams');
        return $pluginInfo ? $this->___callPlugins('getSeoparams', func_get_args(), $pluginInfo) : parent::getSeoparams();
    }
