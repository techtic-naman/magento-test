<?php
namespace Amasty\Base\Model\AdminNotification\Model\ResourceModel\Inbox\Collection\Exists;

/**
 * Interceptor class for @see \Amasty\Base\Model\AdminNotification\Model\ResourceModel\Inbox\Collection\Exists
 */
class Interceptor extends \Amasty\Base\Model\AdminNotification\Model\ResourceModel\Inbox\Collection\Exists implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function execute(\SimpleXMLElement $item)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('execute', func_get_args(), $pluginInfo) : parent::execute($item);
    }
