<?php
namespace Amasty\Storelocator\Model\ResourceModel\Review\Collection;

/**
 * Interceptor class for @see \Amasty\Storelocator\Model\ResourceModel\Review\Collection
 */
class Interceptor extends \Amasty\Storelocator\Model\ResourceModel\Review\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinCustomerData');
        return $pluginInfo ? $this->___callPlugins('joinCustomerData', func_get_args(), $pluginInfo) : parent::joinCustomerData();
    }
