...
class Interceptor extends \Amasty\Storelocator\Model\ResourceModel\Location\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyDefaultFilters');
        return $pluginInfo ? $this->___callPlugins('applyDefaultFilters', func_get_args(), $pluginInfo) : parent::applyDefaultFilters();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareRequestParams');
        return $pluginInfo ? $this->___callPlugins('prepareRequestParams', func_get_args(), $pluginInfo) : parent::prepareRequestParams($attributesData);
    }

    /**
     * {@inheritdoc}
     */
    public function load($printQuery = false, $logQuery = false) : \Amasty\Storelocator\Model\ResourceModel\Location\Collection
    {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addDistance');
        return $pluginInfo ? $this->___callPlugins('addDistance', func_get_args(), $pluginInfo) : parent::addDistance($select);
    }

    /**
     * {@inheritdoc}
     */
    public function addDistanceByParams(float $lat, float $lng, bool $sortByDistance, float $radius, \Magento\Framework\DB\Select $select) : \Magento\Framework\DB\Select
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addDistanceByParams');
        return $pluginInfo ? $this->___callPlugins('addDistanceByParams', func_get_args(), $pluginInfo) : parent::addDistanceByParams($lat, $lng, $sortByDistance, $radius, $select);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyAttributeFilters');
        return $pluginInfo ? $this->___callPlugins('applyAttributeFilters', func_get_args(), $pluginInfo) : parent::applyAttributeFilters($params);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addConditionsToSelect');
        return $pluginInfo ? $this->___callPlugins('addConditionsToSelect', func_get_args(), $pluginInfo) : parent::addConditionsToSelect($attributeId, $value);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByStores');
        return $pluginInfo ? $this->___callPlugins('addFilterByStores', func_get_args(), $pluginInfo) : parent::addFilterByStores($storeIds);
    }

    /**
     * {@inheritdoc}
     */
    public function filterLocationsByProduct($productId, $storeIds = 0)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterLocationsByProduct');
        return $pluginInfo ? $this->___callPlugins('filterLocationsByProduct', func_get_args(), $pluginInfo) : parent::filterLocationsByProduct($productId, $storeIds);
    }

    /**
     * {@inheritdoc}
     */
    public function filterLocationsByCategory($categoryId, $storeIds = 0)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterLocationsByCategory');
        return $pluginInfo ? $this->___callPlugins('filterLocationsByCategory', func_get_args(), $pluginInfo) : parent::filterLocationsByCategory($categoryId, $storeIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyFrontendFilter');
        $pluginInfo ? $this->___callPlugins('applyFrontendFilter', func_get_args(), $pluginInfo) : parent::applyFrontendFilter($locationIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLocationData');
        return $pluginInfo ? $this->___callPlugins('getLocationData', func_get_args(), $pluginInfo) : parent::getLocationData();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinScheduleTable');
        return $pluginInfo ? $this->___callPlugins('joinScheduleTable', func_get_args(), $pluginInfo) : parent::joinScheduleTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinMainImage');
        return $pluginInfo ? $this->___callPlugins('joinMainImage', func_get_args(), $pluginInfo) : parent::joinMainImage();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdsOnPage');
        return $pluginInfo ? $this->___callPlugins('getIdsOnPage', func_get_args(), $pluginInfo) : parent::getIdsOnPage();
    }
