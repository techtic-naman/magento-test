<?php
namespace Amasty\Storelocator\Model\ResourceModel\Gallery\Collection;

/**
 * Interceptor class for @see \Amasty\Storelocator\Model\ResourceModel\Gallery\Collection
 */
class Interceptor extends \Amasty\Storelocator\Model\ResourceModel\Gallery\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Amasty\Storelocator\Model\ResourceModel\Gallery\CollectionFactory $factory, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $factory, $connection, $resource);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImagesByLocation');
        return $pluginInfo ? $this->___callPlugins('getImagesByLocation', func_get_args(), $pluginInfo) : parent::getImagesByLocation($locationId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getByNameAndLocation');
        return $pluginInfo ? $this->___callPlugins('getByNameAndLocation', func_get_args(), $pluginInfo) : parent::getByNameAndLocation($locationId, $name);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBaseLocationImage');
        return $pluginInfo ? $this->___callPlugins('getBaseLocationImage', func_get_args(), $pluginInfo) : parent::getBaseLocationImage($locationId);
    }
