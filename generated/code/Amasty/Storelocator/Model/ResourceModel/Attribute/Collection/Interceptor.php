...
class Interceptor extends \Amasty\Storelocator\Model\ResourceModel\Attribute\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function joinAttributes($types)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('joinAttributes', func_get_args(), $pluginInfo) : parent::joinAttributes($types);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'preparedAttributes');
        return $pluginInfo ? $this->___callPlugins('preparedAttributes', func_get_args(), $pluginInfo) : parent::preparedAttributes($allAttributes, $storeId);
    }
