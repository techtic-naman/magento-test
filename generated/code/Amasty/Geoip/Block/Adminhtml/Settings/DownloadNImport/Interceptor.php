...
class Interceptor extends \Amasty\Geoip\Block\Adminhtml\Settings\DownloadNImport implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDNIData');
        return $pluginInfo ? $this->___callPlugins('setDNIData', func_get_args(), $pluginInfo) : parent::setDNIData($block);
    }
