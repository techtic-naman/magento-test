...
class Interceptor extends \Amasty\Geoip\Block\Adminhtml\Settings\Import implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setImportData');
        return $pluginInfo ? $this->___callPlugins('setImportData', func_get_args(), $pluginInfo) : parent::setImportData($block);
    }
