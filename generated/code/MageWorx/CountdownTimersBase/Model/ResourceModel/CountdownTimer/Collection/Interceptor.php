<?php
namespace MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection;

/**
 * Interceptor class for @see \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
 */
class Interceptor extends \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\Stdlib\DateTime\TimezoneInterface $timezone, \Magento\Framework\Serialize\Serializer\Json $serializer, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $timezone, $serializer, $connection, $resource);
    }
     ...
     * {@inheritdoc}
     */
    public function addStoreFilter($store, $withAdmin = true) : \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
    {
     ...
     * {@inheritdoc}
     */
    public function addCustomerGroupFilter($customerGroup) : \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerGroupFilter');
        return $pluginInfo ? $this->___callPlugins('addCustomerGroupFilter', func_get_args(), $pluginInfo) : parent::addCustomerGroupFilter($customerGroup);
    }

    /**
     * {@inheritdoc}
     */
    public function addProductFilter($product) : \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductFilter');
        return $pluginInfo ? $this->___callPlugins('addProductFilter', func_get_args(), $pluginInfo) : parent::addProductFilter($product);
    }

    /**
     * {@inheritdoc}
     */
    public function addIdsFilter(array $countdownTimerIds, $exclude = false) : \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIdsFilter');
        return $pluginInfo ? $this->___callPlugins('addIdsFilter', func_get_args(), $pluginInfo) : parent::addIdsFilter($countdownTimerIds, $exclude);
    }

    /**
     * {@inheritdoc}
     */
    public function addDateFilter() : \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
    {
     ...
     * {@inheritdoc}
     */
    public function addLoyalDateFilter() : \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLoyalDateFilter');
        return $pluginInfo ? $this->___callPlugins('addLoyalDateFilter', func_get_args(), $pluginInfo) : parent::addLoyalDateFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAllAssociations');
        $pluginInfo ? $this->___callPlugins('addAllAssociations', func_get_args(), $pluginInfo) : parent::addAllAssociations();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAssociatedStoreViews');
        $pluginInfo ? $this->___callPlugins('addAssociatedStoreViews', func_get_args(), $pluginInfo) : parent::addAssociatedStoreViews();
    }

    /**
     * {@inheritdoc}
     */
    public function addAttributeInConditionFilter($attributeCode) : \MageWorx\CountdownTimersBase\Model\ResourceModel\CountdownTimer\Collection
    {
