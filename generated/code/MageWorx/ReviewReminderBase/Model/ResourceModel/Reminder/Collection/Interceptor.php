<?php
namespace MageWorx\ReviewReminderBase\Model\ResourceModel\Reminder\Collection;

/**
 * Interceptor class for @see \MageWorx\ReviewReminderBase\Model\ResourceModel\Reminder\Collection
 */
class Interceptor extends \MageWorx\ReviewReminderBase\Model\ResourceModel\Reminder\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function addStoreFilter($store, $withAdmin = true) : \MageWorx\ReviewReminderBase\Model\ResourceModel\Reminder\Collection
    {
     ...
     * {@inheritdoc}
     */
    public function addCustomerGroupFilter($customerGroup) : \MageWorx\ReviewReminderBase\Model\ResourceModel\Reminder\Collection
    {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAssociatedCustomerGroups');
        $pluginInfo ? $this->___callPlugins('addAssociatedCustomerGroups', func_get_args(), $pluginInfo) : parent::addAssociatedCustomerGroups();
    }

    /**
     * {@inheritdoc}
     */
    public function getItemByParams($period, $customerGroup, $storeId) : ?\MageWorx\ReviewReminderBase\Api\Data\ReminderInterface
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemByParams');
        return $pluginInfo ? $this->___callPlugins('getItemByParams', func_get_args(), $pluginInfo) : parent::getItemByParams($period, $customerGroup, $storeId);
    }
