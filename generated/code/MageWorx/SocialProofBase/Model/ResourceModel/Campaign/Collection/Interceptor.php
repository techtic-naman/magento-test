<?php
namespace MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection;

/**
 * Interceptor class for @see \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection
 */
class Interceptor extends \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Framework\Serialize\Serializer\Json $serializer, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $serializer, $connection, $resource);
    }
     ...
     * {@inheritdoc}
     */
    public function addStoreFilter($store, $withAdmin = true) : \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection
    {
     ...
     * {@inheritdoc}
     */
    public function addCustomerGroupFilter($customerGroup) : \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection
    {
     ...
     * {@inheritdoc}
     */
    public function addPageTypeFilter($pageType) : \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPageTypeFilter');
        return $pluginInfo ? $this->___callPlugins('addPageTypeFilter', func_get_args(), $pluginInfo) : parent::addPageTypeFilter($pageType);
    }

    /**
     * {@inheritdoc}
     */
    public function addAssociatedEntityFilter($id) : \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAssociatedEntityFilter');
        return $pluginInfo ? $this->___callPlugins('addAssociatedEntityFilter', func_get_args(), $pluginInfo) : parent::addAssociatedEntityFilter($id);
    }

    /**
     * {@inheritdoc}
     */
    public function addIdsFilter($campaignIds, $exclude = false) : \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIdsFilter');
        return $pluginInfo ? $this->___callPlugins('addIdsFilter', func_get_args(), $pluginInfo) : parent::addIdsFilter($campaignIds, $exclude);
    }
     ...
     * {@inheritdoc}
     */
    public function addAttributeInConditionFilter($attributeCode) : \MageWorx\SocialProofBase\Model\ResourceModel\Campaign\Collection
    {
