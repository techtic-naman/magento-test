<?php
namespace Webkul\Walletsystem\Model\ResourceModel\Wallettransaction\Collection;

/**
 * Interceptor class for @see \Webkul\Walletsystem\Model\ResourceModel\Wallettransaction\Collection
 */
class Interceptor extends \Webkul\Walletsystem\Model\ResourceModel\Wallettransaction\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMonthlyTransactionDetails');
        return $pluginInfo ? $this->___callPlugins('getMonthlyTransactionDetails', func_get_args(), $pluginInfo) : parent::getMonthlyTransactionDetails($customerId, $firstDay, $lastDay);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAlias');
        return $pluginInfo ? $this->___callPlugins('addAlias', func_get_args(), $pluginInfo) : parent::addAlias($collection, $senderType, $action);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setTableRecords');
        return $pluginInfo ? $this->___callPlugins('setTableRecords', func_get_args(), $pluginInfo) : parent::setTableRecords($ids, $columnData);
    }
