...
class Interceptor extends \Webkul\Walletsystem\Model\Quote\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getHelper()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getHelper', func_get_args(), $pluginInfo) : parent::getHelper();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getorderRegistry');
        return $pluginInfo ? $this->___callPlugins('getorderRegistry', func_get_args(), $pluginInfo) : parent::getorderRegistry();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkWalletProduct');
        return $pluginInfo ? $this->___callPlugins('checkWalletProduct', func_get_args(), $pluginInfo) : parent::checkWalletProduct($items);
    }
