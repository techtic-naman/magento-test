...
class Interceptor extends \Webkul\Walletsystem\Model\Attribute\Backend\WalletCashBack implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'validateCashback');
        return $pluginInfo ? $this->___callPlugins('validateCashback', func_get_args(), $pluginInfo) : parent::validateCashback($object);
    }
