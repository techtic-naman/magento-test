...
class Interceptor extends \Webkul\Walletsystem\Model\PaymentMethod implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoaderImage');
        return $pluginInfo ? $this->___callPlugins('getLoaderImage', func_get_args(), $pluginInfo) : parent::getLoaderImage();
    }
