<?php
namespace Webkul\Helpdesk\Model\ResourceModel\Agent\Grid\Agentlist;

/**
 * Interceptor class for @see \Webkul\Helpdesk\Model\ResourceModel\Agent\Grid\Agentlist
 */
class Interceptor extends \Webkul\Helpdesk\Model\ResourceModel\Agent\Grid\Agentlist implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setAggregations($aggregationsData)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setAggregations', func_get_args(), $pluginInfo) : parent::setAggregations($aggregationsData);
    }
