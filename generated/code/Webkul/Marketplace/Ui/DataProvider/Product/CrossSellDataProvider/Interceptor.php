<?php
namespace Webkul\Marketplace\Ui\DataProvider\Product\CrossSellDataProvider;

/**
 * Interceptor class for @see \Webkul\Marketplace\Ui\DataProvider\Product\CrossSellDataProvider
 */
class Interceptor extends \Webkul\Marketplace\Ui\DataProvider\Product\CrossSellDataProvider implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct($name, $primaryFieldName, $requestFieldName, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $collectionFactory, \Magento\Framework\App\RequestInterface $request, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, \Magento\Store\Api\StoreRepositoryInterface $storeRepository, \Magento\Catalog\Api\ProductLinkRepositoryInterface $productLinkRepository, \Magento\Customer\Model\Session $customerSession, \Webkul\Marketplace\Model\ProductFactory $mpProductModel, \Webkul\Marketplace\Helper\Data $mpHelper, $addFieldStrategies, $addFilterStrategies, array $meta = [], array $data = [])
    {
        $this->___init();
        parent::__construct($name, $primaryFieldName, $requestFieldName, $collectionFactory, $request, $productRepository, $storeRepository, $productLinkRepository, $customerSession, $mpProductModel, $mpHelper, $addFieldStrategies, $addFilterStrategies, $meta, $data);
    }
