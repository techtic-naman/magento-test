<?php
namespace Webkul\Marketplace\Model\ResourceModel\Product\FrontGrid\Collection;

/**
 * Interceptor class for @see \Webkul\Marketplace\Model\ResourceModel\Product\FrontGrid\Collection
 */
class Interceptor extends \Webkul\Marketplace\Model\ResourceModel\Product\FrontGrid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Eav\Model\ResourceModel\Entity\Attribute $attribute, \Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Store\Model\StoreManagerInterface $storeManager, \Webkul\Marketplace\Helper\Data $mpHelper, $mainTable, $eventPrefix, $eventObject, $resourceModel, $model = 'Magento\\Framework\\View\\Element\\UiComponent\\DataProvider\\Document', ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($attribute, $entityFactory, $logger, $fetchStrategy, $eventManager, $storeManager, $mpHelper, $mainTable, $eventPrefix, $eventObject, $resourceModel, $model, $connection, $resource);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllProducts');
        return $pluginInfo ? $this->___callPlugins('getAllProducts', func_get_args(), $pluginInfo) : parent::getAllProducts($limit, $offset);
    }
