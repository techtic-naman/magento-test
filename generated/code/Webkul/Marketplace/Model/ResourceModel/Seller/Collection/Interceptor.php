...
class Interceptor extends \Webkul\Marketplace\Model\ResourceModel\Seller\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAllSellerUrls');
        return $pluginInfo ? $this->___callPlugins('addAllSellerUrls', func_get_args(), $pluginInfo) : parent::addAllSellerUrls();
    }
