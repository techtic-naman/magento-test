...
class Interceptor extends \Webkul\Marketplace\Model\ResourceModel\Orders\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinSellerTable');
        return $pluginInfo ? $this->___callPlugins('joinSellerTable', func_get_args(), $pluginInfo) : parent::joinSellerTable();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSellerTableFilter');
        return $pluginInfo ? $this->___callPlugins('addSellerTableFilter', func_get_args(), $pluginInfo) : parent::addSellerTableFilter($field, $filter);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addActiveSellerFilter');
        return $pluginInfo ? $this->___callPlugins('addActiveSellerFilter', func_get_args(), $pluginInfo) : parent::addActiveSellerFilter();
    }
