<?php
namespace Webkul\Marketplace\Console\Command\AssignSellerId;

/**
 * Interceptor class for @see \Webkul\Marketplace\Console\Command\AssignSellerId
 */
class Interceptor extends \Webkul\Marketplace\Console\Command\AssignSellerId implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $appState, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, \Webkul\Marketplace\Model\ProductFactory $sellerProduct, \Magento\Framework\Api\FilterBuilder $filterBuilder, \Magento\Framework\Api\SearchCriteriaBuilder $searchCriteria)
    {
        $this->___init();
        parent::__construct($appState, $productRepository, $sellerProduct, $filterBuilder, $searchCriteria);
    }
    ...
    public function setAreaCode()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setAreaCode', func_get_args(), $pluginInfo) : parent::setAreaCode();
    }
